...
public interface ITokenService
{
    ...
    /// </summary>
    /// <param name="sessionId">
    /// The unique identifier of the active session the refresh token belongs to.
    /// </param>
    /// <returns>
    /// The generated refresh token string.
    /// </returns>
    Task<string> GenerateRefreshTokenAsync(Guid sessionId, CancellationToken cancellationToken = default);
}

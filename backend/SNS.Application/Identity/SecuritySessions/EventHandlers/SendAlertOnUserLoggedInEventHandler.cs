...
public class SendAlertOnUserLoggedInEventHandler : INotificationHandler<DomainEventNotification<UserLoggedInEvent>>
{
    private readonly IUrlGeneratorService _urlGenerator;
    private readonly IEmailSenderService _emailSenderService;
    private readonly IEmailTemplateProvider _emailTemplateProvider;
    private readonly IAppLogger<SendAlertOnUserLoggedInEventHandler> _appLogger;

    public SendAlertOnUserLoggedInEventHandler(
        IUrlGeneratorService urlGenerator,
        IEmailSenderService emailSenderService,
        IEmailTemplateProvider emailTemplateProvider,
        IAppLogger<SendAlertOnUserLoggedInEventHandler> appLogger)

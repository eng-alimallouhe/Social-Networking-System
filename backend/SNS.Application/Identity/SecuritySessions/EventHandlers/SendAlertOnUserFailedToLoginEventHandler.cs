...
internal class SendAlertOnUserFailedToLoginEventHandler :
    INotificationHandler<DomainEventNotification<UserFailedToLoginEvent>>
{
    private readonly IEmailSenderService _emailSenderService;
    private readonly IEmailTemplateProvider _emailTemplateProvider;
    private readonly IAppLogger<SendAlertOnUserFailedToLoginEventHandler> _logger;

    public SendAlertOnUserFailedToLoginEventHandler(
        IEmailSenderService emailSenderService,
        IEmailTemplateProvider emailTemplateProvider,
        IAppLogger<SendAlertOnUserFailedToLoginEventHandler> logger)
    {
    ...
    public async Task Handle(DomainEventNotification<UserFailedToLoginEvent> notification, CancellationToken cancellationToken)
    {

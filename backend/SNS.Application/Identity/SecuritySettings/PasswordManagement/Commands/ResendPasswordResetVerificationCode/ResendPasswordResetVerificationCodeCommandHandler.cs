...
public sealed class ResendPasswordResetVerificationCodeCommandHandler : ICommandHandler<ResendPasswordResetVerificationCodeCommand, PasswordResetResponse>
{
    ...
    public ResendPasswordResetVerificationCodeCommandHandler(
    ...
    public async Task<Result<PasswordResetResponse>> Handle(ResendPasswordResetVerificationCodeCommand request, CancellationToken cancellationToken)
    {
        ...
        var recipientAddress =
            user.UserSecuritySettings.DefaultCommunicationMethod == CommunicationMethod.RecoveryEmail?

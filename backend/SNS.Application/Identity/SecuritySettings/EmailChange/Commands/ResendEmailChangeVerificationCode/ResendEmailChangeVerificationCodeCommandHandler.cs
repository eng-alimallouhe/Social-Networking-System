...
public sealed class ResendEmailChangeVerificationCodeCommandHandler : 
    ICommandHandler<ResendEmailChangeVerificationCodeCommand, IdentifierChangeResponseDto>
{
    ...
    public ResendEmailChangeVerificationCodeCommandHandler(
    ...
    public async Task<Result<IdentifierChangeResponseDto>> Handle(ResendEmailChangeVerificationCodeCommand request, CancellationToken cancellationToken)
    {

...
public class SendUserLoginWithSecurityCodeAlertEmailHandler : INotificationHandler<DomainEventNotification<UserLoggedInBySecurityCodeEvent>>
{
    ...
    public SendUserLoginWithSecurityCodeAlertEmailHandler(

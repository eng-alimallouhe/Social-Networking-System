...
internal class DeleteDocumentsUserBannedEventHandler :
    INotificationHandler<DomainEventNotification<UserBannedEvent>>
{
    ...
    private readonly IAppLogger<DeleteDocumentsUserBannedEventHandler> _logger;

    public DeleteDocumentsUserBannedEventHandler(
        ...
        IAppLogger<DeleteDocumentsUserBannedEventHandler> logger)
    {

...
public class UserActivatedDocumentEventHandler : INotificationHandler<DomainEventNotification<UserActivatedIntegrationEvent>>
{
    ...
    private readonly IAppLogger<UserActivatedDocumentEventHandler> _logger;
    private readonly ProfileSettings _profileSettings;

    public UserActivatedDocumentEventHandler(
        ...
        IAppLogger<UserActivatedDocumentEventHandler> logger,
    ...
    public async Task Handle(DomainEventNotification<UserActivatedIntegrationEvent> notification, CancellationToken cancellationToken)
    {
        ...
        var problemDocuments = await _dbContext.Problems
            ...
            .Select(pr => new ProblemDocument
            {
                ...
                CommunityLogoUrl = pr.Community != null ? pr.Community.LogoUrl : null,
        ...
        var projectDocuments = await _dbContext.Projects
            ...
            .Select(pr => new ProjectDocument
            {
                ...
                TopThreeContributors = pr.Contributors
                    ...
                    {
                        Id = c.Id,
                        ContributorProfilePictureUrl = c.Contributor.ProfilePictureUrl ?? _profileSettings.DefaultProfilePictureUrl,

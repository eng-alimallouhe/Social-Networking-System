...
internal class ActivateProfileOnUserUnBannedEventHandler: 
    INotificationHandler<DomainEventNotification<UserUnBannedEvent>>
{
    ...
    private readonly IAppLogger<UserUnBannedEvent> _logger;
    public ActivateProfileOnUserUnBannedEventHandler(
        ISoftDeletableRepository<Profile> profileRepo,
        IUnitOfWork unitOfWork,
        IAppLogger<UserUnBannedEvent> logger)
    {

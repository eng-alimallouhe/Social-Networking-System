...
public sealed class ResendActivationCodeCommandHandler : ICommandHandler<ResendActivationCodeCommand, RegisterResponseDto>
{
    ...
    public async Task<Result<RegisterResponseDto>> Handle(ResendActivationCodeCommand request, CancellationToken cancellationToken)
    {

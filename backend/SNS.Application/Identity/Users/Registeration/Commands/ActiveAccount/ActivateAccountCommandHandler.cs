...
public sealed class ActivateAccountCommandHandler : ICommandHandler<ActivateAccountCommand, AuthTokensDto>
{
    ...
    public async Task<Result<AuthTokensDto>> Handle(ActivateAccountCommand request, CancellationToken cancellationToken)
    {

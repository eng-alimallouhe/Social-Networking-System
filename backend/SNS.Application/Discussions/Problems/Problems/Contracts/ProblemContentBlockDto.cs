...
/// <summary>
/// Represents a structured content block within a discussion problem.
/// </summary>
...
public sealed record ProblemContentBlockDto(
    Guid Id,
    ProblemBlockType Type,
    string Content,
    string? ExtraInfo,
    int Order
);
...
/// <summary>
/// Payload contract for creating or updating a problem content block.
/// </summary>
/// <param name="Type">The content block type (Text, Code, Image, Video).</param>
...
public sealed record CreateProblemContentBlockDto(
    ProblemBlockType Type,
    string Content,
    string? ExtraInfo,
    int Order

...
/// <param name="Author">Snapshot of the solution author profile using shared ProfileSnapshotDto.</param>
/// <param name="ContentBlocks">Ordered structured content blocks of the solution.</param>
...
/// <param name="CurrentUserVote">VoteType cast by the authenticated user, if any.</param>
/// <param name="IsUpVotedByCurrentUser">True if the current user has upvoted this solution.</param>
/// <param name="IsDownVotedByCurrentUser">True if the current user has downvoted this solution.</param>

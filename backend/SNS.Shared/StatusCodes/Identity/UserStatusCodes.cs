...
public static class UserStatusCodes
{
    ...
    public static readonly StatusCode HighRiskLoginAttempt =
        new(Category, 401);
    ...
    /// <para>HTTP Equivalent: 20 Created</para>
    /// </summary>
    public static readonly StatusCode Unauthorized =
        new(Category, 400);
    ...
    /// <summary>
    /// Indicates a conflict with the current password and the new.
    /// <para>HTTP Equivalent: 409 Conflict</para>
    /// </summary>
    ...
    /// </summary>
    public static readonly StatusCode Deactivated =
        new(Category, 403);

    /// <summary>
    /// Indicates that the user account is temporarily locked due to exceeding the maximum number of failed login attempts.
    /// The frontend should inform the user to try again after the lockout period (e.g., 15 minutes) or initiate a password reset.
    /// <para>HTTP Equivalent: 429 Too Many Requests</para>
    /// </summary>
    public static readonly StatusCode LockedOut =
        new(Category, 429);
    ...
    public static readonly StatusCode MaxLoginAttempts =
        new(Category, 4051);
}

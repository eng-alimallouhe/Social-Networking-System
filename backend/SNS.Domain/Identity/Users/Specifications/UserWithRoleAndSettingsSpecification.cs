...
/// </summary>
public class UserWithRoleAndSettingsSpecification : ISingleEntitySpecification<User>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserWithRoleAndSettingsSpecification"/> class.
    /// </summary>
    /// <param name="userId">
    /// The unique identifier of the user to retrieve.
    /// </param>
    public UserWithRoleAndSettingsSpecification(Guid userId)
    {

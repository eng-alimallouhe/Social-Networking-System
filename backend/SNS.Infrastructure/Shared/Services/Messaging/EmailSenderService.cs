...
using SNS.Shared.StatusCodes.Messaging;
...
public class EmailSenderService : IEmailSenderService
{
    ...
    public async Task<Result> SendEmailAsync(string toEmail, string subject, string message, CancellationToken cancellationToken = default)
    {

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoObjectKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PushTarget = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePictureObjectKey = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    LogoObjectKey = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MutedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileTags_Profiles_TagId",
                        column: x => x.TagId,
                        principalSchema: "Profiles",
                        principalTable: "Profiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostMentions", x => new { x.ProfileId, x.PostId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostMentions_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalSchema: "Profiles",
                        principalTable: "Profiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentMentions", x => new { x.ProfileId, x.CommentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentMentions_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalSchema: "Profiles",
                        principalTable: "Profiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "", 0, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", 2, false, new Guid("00000000-0000-0000-0000-000000000001"), 0, null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "" });

            migrationBuilder.InsertData(
                schema: "Profiles",
                table: "Profiles",
                columns: new[] { "Id", "Bio", "CreatedAt", "FacebookUrl", "FullName", "GitHubUrl", "IsActive", "LinkedInUrl", "Location", "ProfilePictureObjectKey", "Reputation", "SkillsSummary", "Specialization", "UpdatedAt", "UserId", "Website", "XUrl" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Deleted User", null, true, null, null, "https://www.google.photoes.com/u/32/Xwq-xerg-hgette-54t", 9999999, null, "Default", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("00000000-0000-0000-0000-000000000001"), null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileTags_ProfileId_TagId",
                schema: "Profiles",
                table: "ProfileTags",
                columns: new[] { "ProfileId", "TagId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecuritySessions_RefreshToken",
                schema: "Identity",
                table: "SecuritySessions",
                column: "RefreshToken",
                unique: true);

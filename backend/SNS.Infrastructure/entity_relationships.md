...
| `Profile` | `Comment` | *None* | *None* | One-to-Many | Restrict | [CommentConfigurations.cs](file:///x:/Social-Networking-System/backend/SNS.Infrastructure/ContentManagement/Comments/Configurations/CommentConfigurations.cs) |
| `Comment` (Parent) | `Comment` (Reply) | `Comment.Replies` | `Comment.ParentComment` | One-to-Many | Restrict | [CommentConfigurations.cs](file:///x:/Social-Networking-System/backend/SNS.Infrastructure/ContentManagement/Comments/Configurations/CommentConfigurations.cs) |
...
| `Profile` | `CommentReaction` | *None* | *None* | One-to-Many | Restrict | [CommentReactionConfigurations.cs](file:///x:/Social-Networking-System/backend/SNS.Infrastructure/ContentManagement/Comments/Configurations/CommentReactionConfigurations.cs) |
...
| `Profile` (Inviter) | `CommunityInvitation` | *None* | *None* | One-to-Many | Restrict | [CommunityInvitationConfiguration.cs](file:///x:/Social-Networking-System/backend/SNS.Infrastructure/ContentManagement/Communities/Configurations/CommunityInvitationConfiguration.cs) |
| `Profile` (Invitee) | `CommunityInvitation` | *None* | *None* | One-to-Many | Restrict | [CommunityInvitationConfiguration.cs](file:///x:/Social-Networking-System/backend/SNS.Infrastructure/ContentManagement/Communities/Configurations/CommunityInvitationConfiguration.cs) |

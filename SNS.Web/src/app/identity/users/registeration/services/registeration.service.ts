...
export class RegisterationService {
    ...
    public verifyUser(request: VerifyUserCommand): Observable<Result<RegisterResponse>> {
        return this.http.post<Result<RegisterResponse>>(`${this.apiUrl}/verify-user`, request);
    }

    public resendVerificationCode(request: ResendVerifyCodeCommand): Observable<Result> {
        return this.http.post<Result>(`${this.apiUrl}/resend-verify-code`, request);
    }
}

...
export class LoginService {
  ...
  public resendTfaCode(request: ResendTwoFactorCodeRequest): Observable<Result<OtpChallengeDto>> {
    return this.http.post<Result<OtpChallengeDto>>(`${this.apiUrl}/resend-tfa-code`, request);
  }
}